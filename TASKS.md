...
Нет запланированных задач. Проект feature-complete.

### Отклонённые фичи

| Фича | Причина отклонения |
|------|--------------------|
| Асимметричные пользователи | Не актуально — все текущие сценарии покрываются существующей моделью |
| Метрики | Не актуально — нет потребности в счётчиках сообщений |
